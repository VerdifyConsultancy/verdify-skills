...
project-router
  ...
  -> sprint-replan
       changed constraints -> standard Markdown handoff -> route caveats and review milestones
  -> sprint-orchestrator
...
```text
skills/                     Twenty-one lifecycle skills plus issue-triage
