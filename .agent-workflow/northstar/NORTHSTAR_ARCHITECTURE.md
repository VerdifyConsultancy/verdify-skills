...
| 3 | Verdify Skills remains proprietary and internal-first. Its already-public repository grants GitHub users the in-Service rights in GitHub's Terms; `UNLICENSED` makes no additional project grant beyond those Terms and applicable law for off-platform use, modification, redistribution, derivative works, or package use. Separate user terms or any broader/open-source grant require legal/IP approval. |
...
| NSQ-015 | Approve a capability-qualified supported Forgejo release (v16 is the current candidate) as internal repository authority and GitHub as an output mirror? | Jason | true | Proposed: approve only after exact-version capability, IdP, repository and governance-history import, review/status/protection/audit, portfolio-work, upgrade, coordinated-restore, and GitHub-unavailable contract tests. | `NSE-20260623-source-control-migration-local-forges`, all three 2026-07-27 technical evidence items |
| NSQ-016 | Approve a Zot package subject plus signed immutable complete pre-promotion release envelope, later-effect ledger receipts, and stable-harness/fresh-volume Argo CD consumer as the authoritative release and non-production acceptance model? | Jason | true | Proposed: approve; the consumer is an acceptance fixture, and promotion identity is the signed envelope digest fixing the complete pre-promotion package/evidence graph while later effects remain ledger receipts. | `NSE-20260709-verdify-skills-adversarial-review`, all three 2026-07-27 technical evidence items |
| NSQ-017 | Keep GitHub source, npm, and GitHub Releases as best-effort proprietary/source-available mirrors that preserve GitHub's in-Service public-repository rights, make no additional project grant beyond GitHub's Terms and applicable law for off-platform/package use, accept issue/security reports but no external code until approved CLA/assignment terms exist, and separately govern freshness, outage, verification, support, licensing, intake, and retirement? | Jason, Skills governance owner, legal/IP owner | true | Proposed: approve subject to legal/IP confirmation of the exact rights statement, so public input remains non-authoritative and internal recovery, additional licensing/contributor rights, distribution, and destructive retirement remain separate decisions. | `NSE-20260727-verdify-skills-local-delivery-inventory`, `NSE-20260727-local-delivery-adversarial-audit`, `NSE-20260727-verdify-skills-public-visibility-license`, `NSE-20260727-github-public-repository-license-terms` |
| NSQ-018 | Approve migration of repository and portfolio-work authority through provider-neutral IDs, imported-history markers, portfolio metadata, and cross-system links while keeping `jvallery/agents#3044` as the GitHub-side migration record until reconciliation? | Jason | true | Proposed: approve; Git mirroring alone cannot move governance authority. | `NSE-20260727-local-delivery-adversarial-audit` |
| NSQ-019 | Approve the complete proposed two-repository pilot envelope, including event scale/age, workflow/release/compute/storage/spend/operator/dual-run limits, availability/support, parity/latency/recovery/mirror/backup/retention objectives, transaction/outage evidence, a 30-minute delayed re-probe, and fourteen healthy days? | Jason, Agent Platform owner, source-control owner, security owner, SRE owner, backup/recovery owner, finance owner, Skills release owner, Skills governance owner | true | Proposed: one rehearsal and one live repository; 500 events/day and 20/minute burst; ten-minute maximum event age except authorized replay; two workflows; one release/day; 16 vCPU, 32 GiB, 200 GiB, USD 250/month, four operator-hours/week, thirty dual-run days; 99.5% monthly availability excluding approved maintenance; 24x7 automated alerting with attended release/cutover windows; 24-hour snapshot age; 30-day restore-rehearsal age; 365-day audit evidence and support-plus-365-day release retention; and the documented transaction, latency, recovery, outage, delayed-probe, and observation thresholds. Every owner accepts or revises applicable values before lock; expansion requires all affected owner dispositions. | `NSE-20260727-local-delivery-adversarial-audit` |
| NSQ-020 | Approve IdP-backed immutable identities, raw-body admission plus a durable effect ledger, minimally scoped trusted status reporting, and separate candidate, trusted validator, critic, integrator, publisher, signer, mirror, GitOps, verifier, approver, and recovery principals as mandatory architecture? | Jason, security owner, Agent Platform owner | true | Proposed: approve and reject any provider or design that cannot prove the boundary. | `NSE-20260727-local-delivery-adversarial-audit` |
...
| ARQ-045 | The control plane has named service ownership and measurable capacity, cost, latency, reliability, recovery, retention, support, and observation objectives. | operability/cost | Before lock, the owners accept or explicitly revise: one rehearsal plus one live repository; 500 admitted events/day and 20/minute burst; ten-minute maximum event age except authorized replay; two workflows and one release/day; 16 vCPU, 32 GiB, 200 GiB, USD 250/month, four operator-hours/week, and thirty-day dual-run limits; 99.5% monthly availability excluding approved maintenance; 24x7 automated alerting with attended release/cutover windows; transaction counts; p95 queue/validation/health/rollback; RPO/RTO and mirror freshness; 24-hour snapshot and 30-day restore-rehearsal age; 365-day audit evidence and support-plus-365-day release retention; outage proof; 30-minute delayed re-probe; and fourteen healthy days. | `PRQ-048` |
...
3. Dual-run both paths and block on any false accept or discrepancy. Complete
   twenty change and three release/rollback transactions within the accepted
   queue, validation, health, rollback, storage, and operator-cost envelope.
...
`CON-011` through `CON-016` remain blocking until Jason and the named owners
resolve `NSQ-015` through `NSQ-020`. Live Forgejo does not yet exist; live Argo
objects and Zot contents were unreadable to this repository service account;
organization-level GitHub controls remain unknown; no cold-node,
GitHub-unavailable, or rollback acceptance has run. Those statements are
limitations and implementation gates, not reasons to infer approval or
readiness.
