...
REQUIRED_SKILLS = %w[
  ...
  sprint-replan sprint-orchestrator controller-loop subagent-worktree platform-readiness gravity-readiness lane-delivery
  independent-critic controller-merge release-verification adversarial-audit consensus-audit-workflow issue-triage
].freeze
